...
class Marsohod2(GenericBoard):
    ...
    def generate(self,
        ...
        """ Generates configs for Marsohod2 """
        ...
        self.__filtered_static = self._filter_none(**{
            ...
            'qsf': {
                ...
                'global_assignments': {
                    ...
                    # Doesn't exist in Marsohod2 configuration file
        ...
        self._configs = super(Marsohod2, self)._generate(project_name,
    ...
    def generate_files(self,
        ...
        """
        return super(Marsohod2, self).generate_files(
    ...
    def archive(self,
        ...
        return super(Marsohod2, self).archive(
            project_name=project_name,
            project_path=project_path,
            force=force,
            **config_filter
