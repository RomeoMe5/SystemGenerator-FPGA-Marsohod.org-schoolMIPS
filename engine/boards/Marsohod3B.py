...
class Marsohod3B(GenericBoard):
    ...
    def generate(self,
        ...
        """ Generates configs for Marsohod3Bis """
        ...
        self._configs = super(Marsohod3B, self)._generate(project_name,
    ...
    def generate_files(self,
        ...
        """
        return super(Marsohod3B, self).generate_files(
    ...
    def archive(self,
        ...
        return super(Marsohod3B, self).archive(
            project_name=project_name,
            project_path=project_path,
            force=force,
            **config_filter
